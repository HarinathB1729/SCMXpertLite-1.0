...
server.bind((SERVER, PORT))    # bind this socket to the address we configured earlier
server.listen(2)
...
while connected:
        try:
            for i in range(0,5):
                route = ['Newyork,USA','Dubai, UAE','Tirupati, India','London,UK']
                ...
                if (routefrom!=routeto):
                    ...
                    userdata = (json.dumps(data,default='str', indent=1)).encode('utf-8')
                    print(userdata)
